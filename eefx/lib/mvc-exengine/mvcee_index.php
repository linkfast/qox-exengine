...
namespace ExEngine\MVC {
	...
	class Index {
		...
		const VERSION = "0.0.2.0"; /// Version of EE MVC Implementation library.
	...
	*/
			...
			*/
			...
			if (!$this->AlwaysSilent) {
                ...
                $LA = new LayoutAssets($this->staticFolder,$this->staticFolderHTTP,$this->controllersFolderHTTP."/?EEMVC_SPECIAL=STATICTAGGED&FILE=");
				$LA->loadAssets();

                $LayoutData = ["Content" => $output, "LayoutAssets" => $LA];
