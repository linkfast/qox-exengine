...
function SoundManager(smURL,smID) {
  ...
  this._failSafely = function() {
    ...
    var flashCPL = '<a href="../../../../../ee/eefx/engines/res/sm2/script/'+flashCPLink+'" title="'+fpgssTitle+'">view/edit</a>';
    var FPGSS = '<a href="../../../../../ee/eefx/engines/res/sm2/script/'+flashCPLink+'" title="Flash Player Global Security Settings">FPGSS</a>';
    if (!_s._disabled) {
  ...
  this._createMovie = function(smID,smURL) {
    ...
    var htmlObject = '<object id="'+smID+'" data="../../../../../ee/eefx/engines/res/sm2/script/'+smURL+'" type="application/x-shockwave-flash" width="100%" height="100%"><param name="movie" value="../../../../../ee/eefx/engines/res/sm2/script/'+smURL+'" /><param name="AllowScriptAccess" value="always" /><param name="quality" value="high" />'+(_s.useHighPerformance && !_s.useMovieStar?'<param name="wmode" value="transparent" /> ':'')+'<param name="bgcolor" value="'+_s.bgColor+'" /><!-- --></object>';
